# USAGE
# python video_cam_recognition.py --encodings encodings.pickle
# python video_cam_recognition.py --encodings encodings.pickle --output output/jurassic_park_trailer_output.avi --display 0
